...
exports.default = defineEventHandler(function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var credentials, apiBase, laravelEndpoint, response, error_1;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                laravelEndpoint = "".concat(apiBase, "/login");
                _c.label = 2;
            case 2:
                _c.trys.push([2, 4, , 5]);
                return [4 /*yield*/, $fetch(laravelEndpoint, {
                        method: "POST",
                        body: credentials,
                    })];
            case 3:
            ...
            case 4:
                error_1 = _c.sent();
                setResponseStatus(event, ((_a = error_1.response) === null || _a === void 0 ? void 0 : _a.status) || 500);
                return [2 /*return*/, {
