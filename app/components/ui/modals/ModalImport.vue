...
:ui="{
        ...
        <div class="space-y-4">
          <div class="p-4 rounded-xl bg-amber-50 dark:bg-amber-500/5 border border-amber-300">
            <p
class="text-xs font-medium mb-1 uppercase tracking-wider"
            ...
            <div class="flex items-baseline gap-2">
              <span class="text-2xl font-black" :class="ui.isDark ? ' text-white' : ' text-slate-900'">
        ...
        <template #footer>
          <div class="flex flex-col gap-2">
            <UButton block color="primary" label="Update Semua (History + Saldo)" class="font-bold py-2.5" />
            <div class="grid grid-cols-2 gap-2">
              <UButton block color="secondary" label="History Aja" class="font-medium" />
              <UButton block color="warning" label="Batal" @click="ui.closeImportModal()" />
            </div>
          </div>
        </template>
      </UCard>
