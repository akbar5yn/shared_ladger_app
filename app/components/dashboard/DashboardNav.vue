<template>
  <section id="navigation-wrapper" class="navigation-wrapper">
    <div id="nav-container" class="nav-container flex justify-center overflow-x-auto pb-4 no-scrollbar">
      <div
v-for="menu in menus" :key="menu.name" class="nav-item flex flex-col items-center gap-2 min-w-[70px]"
        ...
        <div
          ...
          <UIcon
:name="menu.icon" class="text-2xl transition-all duration-300" :class="[
            {
              'font-light': isDark,
        ...
        <span
class="text-xs font-medium transition-all duration-300" :class="[
...
const { handleLogout } = useDrawerActions()
